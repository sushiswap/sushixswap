...
export interface TridentSwapAdapterInterface extends utils.Interface {
  functions: {
...
export interface TridentSwapAdapter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TridentSwapAdapterInterface;
